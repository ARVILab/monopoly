...
def main():
    ...
    for n_game in range(n_games):
        ...
        for n_round in range(n_rounds):
            ...
            for player in game.players:
                ...
                while True:
                    ...
                    #     print('{:12} {}'.format(config.monopolies[counter], state[0][i:i + 4]))
                    #     counter += 1
                    # print('Position:', state[0][40])
                    # print('Properties value:', state[0][41])
                    # print('Money:', state[0][42])
                    # print('----------REWARD---------')
        ...
        # game.lost_players[0].storage.show()
